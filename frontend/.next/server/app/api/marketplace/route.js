"use strict";(()=>{var e={};e.id=36,e.ids=[36],e.modules={2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7738:(e,a,t)=>{t.r(a),t.d(a,{originalPathname:()=>k,patchFetch:()=>A,requestAsyncStorage:()=>g,routeModule:()=>l,serverHooks:()=>_,staticGenerationAsyncStorage:()=>T});var r={};t.r(r),t.d(r,{GET:()=>d,POST:()=>p});var i=t(9303),n=t(8716),s=t(670),o=t(7070),c=t(2049);async function d(e){try{let a=await (0,c.e)(),{searchParams:t}=new URL(e.url),r=t.get("category"),i=t.get("search"),n=t.get("sort")||"popular",s=parseInt(t.get("limit")||"20"),d=a.from("memory_packages").select(`
        id,
        name,
        description,
        category,
