"use strict";(()=>{var e={};e.id=281,e.ids=[281],e.modules={2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7872:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>l,patchFetch:()=>p,requestAsyncStorage:()=>c,routeModule:()=>N,serverHooks:()=>L,staticGenerationAsyncStorage:()=>_});var a={};r.r(a),r.d(a,{DELETE:()=>T,GET:()=>E,POST:()=>d});var s=r(9303),i=r(8716),n=r(670),o=r(7070),m=r(2049);async function E(e){try{let e=await (0,m.e)(),{data:{user:t},error:r}=await e.auth.getUser();if(r||!t)return o.NextResponse.json({error:"Unauthorized"},{status:401});let{data:a,error:s}=await e.from("team_members").select(`
        role,
        joined_at,
        team:teams (
          id,
